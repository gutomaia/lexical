...
def is_string(code):
    return (
        sys.version_info >= (3, 0) and type(code).__name__ == 'str'
    ) or type(code).__name__ == 'unicode'


def is_bytes(code):
    return (
        sys.version_info >= (3, 0) and type(code).__name__ == 'bytes'
    ) or type(code).__name__ == 'str'
